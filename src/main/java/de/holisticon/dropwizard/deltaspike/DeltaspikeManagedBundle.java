...
public class DeltaspikeManagedBundle<T extends Configuration> implements ConfiguredBundle<T>, Managed  {
    ...
    public void start() throws Exception {
        logger.error("------------------- bundle-start-empty");
    }

    @Override
    public void stop() throws Exception {
        logger.error("------------------- bundle-stop-1");
